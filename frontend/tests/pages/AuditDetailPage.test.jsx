        ...
        HttpResponse.json({
          auditLog: {
            ...
            before: {
              ...
              bcsScore: {
                isMedianAccurate: null, isMeanAccurate: null,
                claude: { finalBcs: 3.0, status: 'success', isTrue: null },
                gemini: { finalBcs: 3.5, status: 'success', isTrue: null },
                openai: { finalBcs: 3.0, status: 'success', isTrue: null },
              },
            },
            after: {
              isApproved: true,
              finalBcs: 4.0, // a genuine override - doesn't match mean or median below
              status: 'completed',
              updatedBy: 'Reviewer B',
              bcsScore: {
                isMedianAccurate: false, isMeanAccurate: false,
                claude: { finalBcs: 3.0, status: 'success', isTrue: false },
                gemini: { finalBcs: 3.5, status: 'success', isTrue: false },
                openai: { finalBcs: 3.0, status: 'success', isTrue: false },
              },
            },
          ...
          auditLog: {
            ...
            before: {
              ...
              bcsScore: {
                isMedianAccurate: null, isMeanAccurate: null,
                gemini: { finalBcs: 3.5, status: 'success', isTrue: null },
                openai: { finalBcs: null, status: 'error', isTrue: null },
              },
            },
            after: {
              isApproved: true,
              finalBcs: 3.5,
              bcsScore: {
                isMedianAccurate: true, isMeanAccurate: true,
                gemini: { finalBcs: 3.5, status: 'success', isTrue: true },
                openai: { finalBcs: null, status: 'error', isTrue: false },
              },
            },
      ...
      http.get('http://localhost:4000/api/audit/e1', () =>
        HttpResponse.json({
          auditLog: {
            ...
            cowsId: '4417',
            action: 'provider_selected',
            before: { isApproved: false, finalBcs: null, bcsScore: {} },
            after: { isApproved: true, finalBcs: 3.0, bcsScore: {} },
            performedBy: null,
            createdAt: '2026-07-10T12:00:00Z',
          },
        })

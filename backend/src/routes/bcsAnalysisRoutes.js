...
// Must precede /:id - otherwise Express would try to match "dashboard-summary"/"pending-review" as an :id param.
router.get('/dashboard-summary', requireAuth(), requireSession(), resolveScope(), bcsAnalysisController.dashboardSummary);
router.get('/pending-review', requireAuth(), requireSession(), resolveScope(), bcsAnalysisController.pendingReview);
